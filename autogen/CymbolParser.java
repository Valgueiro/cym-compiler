...
public class CymbolParser extends Parser {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ifStat", "elseStat", "exprStat", "exprList", "stat", "expr"
		};
	}
	...
	public static class TyypeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CymbolListener ) ((CymbolListener)listener).enterTyype(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CymbolListener ) ((CymbolListener)listener).exitTyype(this);
		}
	}
