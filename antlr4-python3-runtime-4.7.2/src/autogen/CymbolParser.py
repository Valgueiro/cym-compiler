...
class CymbolParser ( Parser ):
    ...
    class AndOrExprContext(ExprContext):
    ...
    class EqualNotEqualExprContext(ExprContext):
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            if la_ == 1:
                localctx = CymbolParser.FuncCallExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                ...
                localctx = CymbolParser.PlusMinusExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 138
                ...
                localctx = CymbolParser.IDExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 142
                self.match(CymbolParser.ID)
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = CymbolParser.CompExprContext(self, CymbolParser.ExprContext(self, _parentctx, _parentState))
                        ...
                        localctx = CymbolParser.MultDivExprContext(self, CymbolParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 155
